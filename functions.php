    ...
    <section class="eg-start-eb-section">
        ...
        <div class="eg-sc-eb-grid">
            <?php while ( $q->have_posts() ) : $q->the_post();
                ...
                $gesperrt = ($si==='mitglieder' && !eg_eb_hat_level(array(3))) || ($si==='angemeldet' && !eg_eb_hat_level(array(2,3)));
            ?>
...
/**
 * BREVO_API_KEY aus der zentralen brevo-proxy.php nachladen,
 * falls sie noch nicht definiert ist.
 */
if (!defined('BREVO_API_KEY')) {
    $eg_brevo_proxy_path = ABSPATH . 'brevo-proxy.php';
    if (file_exists($eg_brevo_proxy_path)) {
        require_once $eg_brevo_proxy_path;
    }
}
